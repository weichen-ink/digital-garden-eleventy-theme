...
TARGET_PATH="/Users/weichen/Documents/github/garden.weichen.ink/content"
...
# 检查rsync是否可用
command -v rsync >/dev/null 2>&1 || error_exit "未找到 rsync 命令"

# 检查git是否可用
command -v git >/dev/null 2>&1 || error_exit "未找到 git 命令"
